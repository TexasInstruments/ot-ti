# DMM RCP+BLE Controller — Host Setup Guides

Host-side setup and test instructions for the TI cc27xx DMM RCP+BLE Controller firmware.

---

## [Ubuntu PC Host Setup Guide](README_UBUNTU_HOST.md)
